...
var (
	...
	projectImage = "example.com/github-issue-operator-home-assignment:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting github-issue-operator-home-assignment integration test suite\n")
